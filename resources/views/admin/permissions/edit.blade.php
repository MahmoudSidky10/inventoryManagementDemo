...
@section('action' , "permissions/$item->id")
@section('nav')
    <ol class="breadcrumb">
...
@section('form-groups')
    ...
    @includeIf('admin.components.form.edit.select', ['label' => trans("language.permission-categories"),'name'=>'category_id', 'items'=> $categories , 'icon' => 'fa fa-list',])
    ...
    @includeIf('admin.components.form.edit.text', ['icon' => 'fa fa-user','label' => trans('language.title'),'name'=>'title', 'placeholder'=>trans('language.title' ),'valid'=>trans('language.vaildation')])
