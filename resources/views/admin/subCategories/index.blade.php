...
@section("buttons")
        ...
        <a class="btn btn-success col-md-1 " href="{{url("/admin/categories/$category_id/subCategories/create")}}">
            {{trans("language.add")}}
        </a>
    ...
    @foreach($items as $item)
        <tr class="text-center">
            ...
            <td>
                    ...
                    @includeIf("admin.components.buttons.edit" , ["href" => "categories/$category_id/subCategories/$item->id/edit"])

                    @includeIf("admin.components.buttons.delete",["message" => "($item->name)" ,  "action" => url("admin/categories/$category_id/subCategories/$item->id")])
...
@section("filters")
    <form method="get" action="{{url("/admin/categories/$category_id/subCategories/")}}">
